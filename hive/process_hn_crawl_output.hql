...
CREATE EXTERNAL TABLE hn_crawl_data (item_id int, url string, num_links int, num_images int, num_scripts int, num_styles int, headers string, text string)
ROW FORMAT DELIMITED FIELDS TERMINATED BY ',';

ADD FILE /home/dc3186/bigdata_project/hive/filter_hn_fields.py;
