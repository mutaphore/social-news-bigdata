...
class CrawlerPipeline(object):
    ...
    def spider_opened(self, spider):
        path = CrawlerPipeline.EXPORT_PATH + spider.instance_id + '_aggregate.csv'
        export_file = open(self.path, 'ab' if os.path.isfile(self.path) else 'wb')
        
        self.files[spider.instance_id] = export_file
    ...
    def spider_closed(self, spider):
        ...
        export_file = self.files.pop(spider.instance_id)
        export_file.close()
